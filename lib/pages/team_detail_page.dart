...
class _TeamDetailPageState extends State<TeamDetailPage> {
  ...
  void initState() {
    super.initState();
    _competitionDetail =
        CompetitionsService.instance.getDetail(widget.competitionId);

    // Find team stats in standings
    try {
      _stats = _competitionDetail.standings
          .firstWhere((s) => s.team == widget.teamName);
    } catch (_) {
      _stats = null;
    }

    _allMatches = CompetitionsService.instance
  ...
  Widget build(BuildContext context) {
    final pastMatches =
        _allMatches.where((m) => m.statusValue == 1).toList().reversed.toList();
          ...
          ListenableBuilder(
            ...
            builder: (context, _) {
              final isFav = FavoritesService.instance
                  .isFavorite(widget.teamName, widget.competitionId);
                ...
                child: Padding(
                  ...
                  child: Material(
                    color: isFav
                        ...
                        : AppBrandColors.green.withValues(alpha: 0.15),
                      ...
                      child: Column(
                        children: [
                          ...
                          Builder(
                            builder: (context) {
                              final parts =
                                  _competitionDetail.groupTitle.split('\n');
                    ...
                    return Column(
                      children: [
                        _PersonListTile(
                          ...
                          trailingText: player.number != null
                              ? '#${player.number}'
                              : null,
                          image: player.image,
        ...
        children: [
          ...
          Expanded(
              child: Center(
                  child: Text('GEN',
                      style:
                          baseStyle?.copyWith(color: AppBrandColors.white)))),
          Expanded(
              child: Center(
                  child: Text('CASA',
                      style: baseStyle?.copyWith(
                          color:
                              AppBrandColors.white.withValues(alpha: 0.6))))),
          Expanded(
              child: Center(
                  child: Text('FUERA',
                      style: baseStyle?.copyWith(
    ...
    return Padding(
      ...
      child: Row(
        children: [
            ...
            child: Row(
              children: [
                if (icon != null) ...[
                  Icon(icon,
                      size: 14,
                      color: (color ?? AppBrandColors.gray400)
          ...
          Expanded(
              child: Center(child: Text('$casa', style: normalValueStyle))),
          Expanded(
              child: Center(child: Text('$fuera', style: normalValueStyle))),
        ],
      ),
    );
  }
            ...
            children: [
              InkWell(
                onTap: () {
                  if (match.home.name ==
                      (context
                          .findAncestorWidgetOfExactType<TeamDetailPage>()
                          ?.teamName)) {
                    return;
                  }
                ...
                child: Row(
                  ...
                  children: [
                    TeamAvatar(
                        label: match.home.short, image: match.home.image),
                    const SizedBox(width: 10),
                  ],
                ),
              ),
